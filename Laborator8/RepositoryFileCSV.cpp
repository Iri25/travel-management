...
RepositoryFileCSV::RepositoryFileCSV() : RepositoryFileTransport()
{
}

RepositoryFileCSV::RepositoryFileCSV(string fileNameIn, string fileNameOut, ValidationTransport* validation) : RepositoryFileTransport(fileNameIn, fileNameOut, validation)
{
	this->loadFromFile();
}
